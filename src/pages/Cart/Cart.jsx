      ...
      <div className="container mx-auto px-4 py-8">
        <div className="flex items-center mb-8">
          <div className="w-12 h-12 bg-primary-100 rounded-full flex items-center justify-center mr-4">
            <i className="fa-solid fa-cart-shopping text-primary-600 text-xl"></i>
          </div>
          <div>
                    ...
                    <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                      ...
                      <div className="flex-grow">
                        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start">
                          <div>
                            <h3 className="font-medium text-gray-800 text-lg">{item.productName}</h3>
                            <p className="text-sm text-gray-500 mt-1">{item.category}</p>
                          </div>
                          <div className="mt-2 sm:mt-0 text-right">
                            <p className="text-primary-600 font-bold">{item.price} L.E</p>
                        ...
                        <div className="flex justify-between items-center mt-4">
                          <p className="font-medium text-gray-700">
                            Subtotal: <span className="text-primary-600">{item.totalPrice} L.E</span>
                          </p>
                          <button 
              ...
              <div className="space-y-3 mb-6">
                ...
                <div className="border-t border-gray-200 pt-3 mt-3">
                  <div className="flex justify-between font-bold text-lg">
                    <span>Total:</span>
                    <span className="text-primary-600">{totalCartPrice} L.E</span>
                  </div>
