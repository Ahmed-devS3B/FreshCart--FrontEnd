            ...
            {wishlistInfo && wishlistInfo.length > 0 ? (
                ...
                <div className="bg-white rounded-lg shadow-md p-8 text-center max-w-2xl mx-auto mt-8">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        ...
                        <Link to="/search"
                            className="bg-white hover:bg-gray-50 text-gray-700 font-medium py-3 px-6 rounded-lg border border-gray-300 transition duration-300 flex items-center justify-center gap-2">
