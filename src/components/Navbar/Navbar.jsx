...
export default function Navbar() {
    ...
    const navLinkClass = ({ isActive }) => {
        return `relative block py-2 md:py-0 before:absolute before:w-0 before:h-0.5 before:bg-primary-800 before:left-0 before:-bottom-1 ${isActive ? 'before:!w-full font-semibold' : ''
            } hover:before:w-full before:transition-[width] before:duration-300`
    }

    return (
        <nav className='bg-slate-100 shadow fixed top-0 right-0 left-0 z-50 overflow-hidden'>
                    ...
                    <div className="hidden md:flex md:items-center md:space-x-6">
                        ...
                        <div className="flex space-x-4">
                            <a href="https://www.facebook.com/share/18XUMjAgUh/?mibextid=wwXIfr" target='_blank' rel="noopener noreferrer">
                                <i className='fa-brands fa-facebook text-blue-600 hover:text-blue-700'></i>
                            </a>
                            <a href="https://www.instagram.com/ahmeed.iibrahiiim?igsh=bTZjdXk3ZXVvb2N1&utm_source=qr" target='_blank' rel="noopener noreferrer">
                                <i className='fa-brands fa-instagram text-amber-600 hover:text-amber-700'></i>
                            </a>
                        </div>
                        ...
                        {role === 'Customer' && token && (
                            <Link to='/cart' className="relative">
                                <i className='fa-solid fa-cart-shopping text-xl hover:text-primary-600'></i>
